...
#that generates an error? Can you make sense of the error message? 
Hello World("print")

#Can you
#make a typo that doesn’t generate an error? Why do you think it didn’t make
#an error?
print("Hello Python woldaasd!")

#1-3. Infinite Skills: If you had infinite programming skills, what would you build? Games
